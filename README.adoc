...
2. Recommendation on issue tracking tool, probably github project can be used, created one https://github.com/users/Vipin-Sharma/projects/1. And we can remove issues from README file.
